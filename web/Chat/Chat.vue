                ...
                <div class="flex-1 flex flex-col gap-3 px-8 pb-4">
                    <template v-for="message in messages.data" :key="message.id">
                        ...
                        <div v-else-if="message.type === 'response'" class="relative group">
                            ...
                            <small
                                v-if="message.model"
                                class="absolute top-full transition-opacity duration-300 opacity-0 group-hover:opacity-100 flex items-center gap-1"
                            >
                                <Icon name="magic-wand" height="12" width="12" /> Generated with {{ message.model }}
                            </small>
                        </div>
